...
export default function StatsBar() {
  return (
    ...
    <section className="relative isolate overflow-hidden text-gray-900 rounded-[32px] mx-auto max-w-7xl mt-16 md:mt-20">
      <div className="bg-white border border-black rounded-2xl w-full  mt-10 mb-10 shadow-sm grid grid-cols-2 md:grid-cols-5  pt-8 md:pt-10 pl-6 md:pl-8 pb-6 md:pb-0 gap-6">
        <div>
